...
<div class="card shadow mb-4 w-50">
    ...
    <div class="card-body">
        ...
        <a href="./src/server.php?editquestn=<?php echo $fetch['question_id'];?>" class="btn btn-primary btn-icon-split">
        <!-- data-toggle="modal" data-target="#editTestQustn"-->
                        <span class="icon text-white-50">
                            <i class="fas fa-edit"></i>
                        </span>
                        <span class="text">Edit</span>
                  </a>
                <span class="float-right"><b>Answer: <?php echo $fetch['correct_opt']; ?></b> </span>
        </p>
        
        <?php } ?>
        <!-- <input type="submit" value="Update Questions" class="btn btn-primary float-right" name='answer-btn'> -->
        </form>
        <p class="mb-0">
            </p>
        </div>
