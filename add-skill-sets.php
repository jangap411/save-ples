...
<head>
   ...
   <meta name="description" content="Learning website, teaching you new skill sets">
    ...
    <title>SAVE PLES - Skill Sets</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Skill Sets</h1>
                    <?php include 'add-skillset-form.php'; ?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="./src/server.php?logout">Logout</a>
                </div>
            </div>
        </div>
    </div>
