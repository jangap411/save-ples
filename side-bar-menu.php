...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- schools -->
        ...
        <!--<div id="collapseSchools" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            ...
            aria-expanded="true" aria-controls="collapseSchools1" onclick="alert('feature coming soon');" >
                ...
                <a class="collapse-item" href="#" onclick="alert('feature coming soon');">School of Sciences</a>
                <a class="collapse-item" href="#" onclick="alert('feature coming soon');">School of Business</a>
            </div>
        </div>
    </li>-->
    ...
    <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="#" onclick="alert('feature Coming out Soon');">Assessment Results</a>
